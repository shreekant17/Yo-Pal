        ...
        <div class="container">
          <span class="logo">
            ...
            <style>
              ...
              .bell-image {
                animation: bellRotate 1s ease-in-out infinite;
              }
            </style>
            <div class="bell" id="bell-icon" >
              <a href="./christmax/index.php"><img class= "bell-image" src="./christmax/images/bell.png" /></a>
            </div>
          </span>
          ...
          <div class="middle">
            ...
            <div class="stories">
              ...
              <?php
                ...
                ?>
                <div class="story" style="background: url('<?php echo $yourstoryContent; ?>') no-repeat center center/cover; justify-content: bottom" onclick="window.location.href='story/story.php?sad=<?php echo $yourstoryContent;?>&sid=<?php echo $yourstoryId?>'">
                  <div class="profile-picture">
              ...
              while($storyRow=mysqli_fetch_assoc($storyResult)){
                ...
                ?>
                <div class="story" style="background: url('<?php echo $storyContent; ?>') no-repeat center center/cover" onclick="window.location.href='story/story.php?sad=<?php echo $storyContent;?>&sid=<?php echo $storyId?>'">
                  <div class="profile-picture">
...
<style>
  ...
  <!--<audio src="Bells.m4a" autoplay loop></audio>-->