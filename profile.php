...
<html lang="en">
  <head>
    ...
    <script src="fetch/jquery.min.js"></script>
    ...
    <main>
      <div class="container">
        ...
        <div class="middle">
          ...
          <div class="feeds">
              <?php 
              $query="SELECT * FROM allPosts, userAccount where userAccount.username='$profileusername' and allPosts.PostedBy=userAccount.Email order by PostedOn desc";
              $result=mysqli_query($conn,$query); 
              ...
              <div class="feed">
                ...
                <div class="action-buttons">
                  <div class="interaction-buttons">
                    ...
                    <label class="commentBox" id=commentBox> <img src="Resources/images/comment.png" width="25px" height="25px" alt="Comment">
