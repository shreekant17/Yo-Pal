    ...
    <div class="container">
      ...
      <div class="form-box login">
        ...
        >
          ...
          <button id="continue_with_google" class="btn">Continue with Google</button>
        </form>
      </div>
      ...
      <div class="form-box register">
        <h2>Register</h2>
        <form action="./register.php" method="post" id='signin-form'>
          <div class="name">
            <div class="input-box">
          ...
          <button id="continue_with_google2" class="btn">Sign up with Google</button>
        </form>
      </div>
    </div>
    </div>
