...
const commentsViewButton = document.querySelectorAll("#commentBox");
const commentsView = document.querySelectorAll(".commentsView");
const closeCommentBoxButton = document.querySelectorAll("#closeCommentBox");
const closeCommentByHome = document.querySelector(".closeCommentByHome");
...
commentsViewButton.forEach(button => {
  button.addEventListener('click', () => {
    // Find the associated commentsView element
    const commentsView = button.parentElement.querySelector('.commentsView');
...
closeCommentBoxButton.forEach(button => {
  button.addEventListener('click', () => {
    commentsView.forEach(commentsViewElement => {
       /* if (commentsViewElement.style.transform !== 'scale(0)' || commentsViewElement.style.transform !== 'translateY(200vh)') {*//*
            commentInput.forEach(commentsInputElement => {
                if (commentsInputElement.value !== '') {
                    commentsInputElement.value = '';
                }
            });
            if (window.innerWidth > 992) {
                commentsViewElement.style.transition = 'all 300ms ease';
                commentsViewElement.style.transform = 'scale(0)';
                document.body.style.overflow = 'auto';
            }
            else {
                commentsViewElement.style.transition = 'all 800ms ease';
                commentsViewElement.style.transform = 'translateY(200vh)';
                document.body.style.overflow = 'auto';
            }
      //}
    });
...
const followButton2 = document.querySelectorAll('.followButton');

if (followButton2) {
    followButton2.forEach(item => {
        item.addEventListener('click', () => {
...
const followersPage = document.querySelector('.followerspage');
const backButtonFollowers = document.querySelector('.backButtonFollowers');

const openFollowersPage = () => {
    if (window.innerWidth > 992) {
        followersPage.style.transform = "scale(1)";
        document.body.style.overflow = "hidden";
    }
    else {
        followersPage.style.transition = "all 500ms ease";
        followersPage.style.transform = "translateY(0)";
        document.body.style.overflow = "hidden";
    }
}

const closeFollowersPage = () => {
    if (window.innerWidth > 992) {
        followersPage.style.transform = "scale(0)";
        document.body.style.overflow = "auto";
    }
    else {
        followersPage.style.transition = "all 800ms ease";
        followersPage.style.transform = "translateY(200vh)";
        document.body.style.overflow = "auto";
    }
    
}

Followers.addEventListener('click', openFollowersPage);
backButtonFollowers.addEventListener('click', closeFollowersPage);
...
const backButtonFollowing = document.querySelector('.backButtonFollowing');

const openFollowingPage = () => {
    if (window.innerWidth > 992) {
        followingPage.style.transform = "scale(1)";
        document.body.style.overflow = "hidden";
    }
    else {
        followingPage.style.transition = "all 500ms ease";
        followingPage.style.transform = "translateY(0)";
        document.body.style.overflow = "hidden";
    }
}

const closeFollowingPage = () => {
    if (window.innerWidth > 992) {
        followingPage.style.transform = "scale(0)";
        document.body.style.overflow = "auto";
    }
    else {
        followingPage.style.transition = "all 800ms ease";
        followingPage.style.transform = "translateY(200vh)";
        document.body.style.overflow = "auto";
    }
    
}

Following.addEventListener('click', openFollowingPage);
backButtonFollowing.addEventListener('click', closeFollowingPage);
